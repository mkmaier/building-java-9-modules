...
* https://openjdk.java.net/projects/jigsaw/quick-start[Module System Quick-Start Guide] (at least)
* https://openjdk.java.net/projects/jigsaw/spec/sotms/[The State of The Module System] (for more details)
...
https://repo.maven.apache.org/maven2/com/google/guava/guava/22.0/[guava-22.0.jar], so according to the
https://openjdk.java.net/projects/jigsaw/spec/sotms/#automatic-modules[rules of automatic module names],
you require `guava`.
...
https://blog.joda.org/2017/05/java-se-9-jpms-automatic-modules.html[Stephen Colebourne argues]
...
them work on with Java 9 modules.

There are various third party plugins which support building modular Java applications:

* https://plugins.gradle.org/plugin/com.zyxist.chainsaw[com.zyxist.chainsaw]
* https://plugins.gradle.org/plugin/org.javamodularity.moduleplugin[org.javamodularity.moduleplugin]

In the future, the Gradle team will be adding first-class support for the module system, but you can begin experimenting today!
